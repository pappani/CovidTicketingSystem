...
<h1>FP Events</h1>
<hr>
<h2>Utenti presenti all'evento corrente</h2>
<button onClick="window.location.href='generateCsvPresent.php';">Genera file Excel</button><br/><br/>
<?php
$user = 'USERNAME'; $password="PASSWORD"; $host="HOST"; $database="DATABASE";
$connstring = "CONNSTRING";
$myconn=@pg_connect($connstring);
$query = "SELECT * FROM iscrittiEventoCorrente WHERE PRESENTE = '1'";
